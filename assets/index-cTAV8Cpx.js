...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function Hh(){return new sr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Du(),fragmentShader:`
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function Vh(){return new sr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Du(),fragmentShader:`
