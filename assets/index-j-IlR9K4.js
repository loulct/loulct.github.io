...
#define LOW_PRECISION`),e}function Mx(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===qf?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===Kf?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===wi&&(e="SHADOWMAP_TYPE_VSM"),e}function Sx(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ps:case Ls:e="ENVMAP_TYPE_CUBE";break;case ll:e="ENVMAP_TYPE_CUBE_UV";break}return e}function yx(r){let e="ENVMAP_MODE_REFLECTION";return r.envMap&&r.envMapMode===Ls&&(e="ENVMAP_MODE_REFRACTION"),e}function Ex(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Eu:e="ENVMAP_BLENDING_MULTIPLY";break;case wm:e="ENVMAP_BLENDING_MIX";break;case Cm:e="ENVMAP_BLENDING_ADD";break}return e}function Tx(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function bx(r,e,t,n){const i=r.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Mx(t),c=Sx(t),u=yx(t),d=Ex(t),f=Tx(t),h=fx(t),g=dx(s),_=i.createProgram();let p,m,A=t.glslVersion?"#version "+t.glslVersion+`
